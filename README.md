...
| [EasyApply](https://github.com/SouhaibBenFarhat/easy-apply) | `brew install --cask souhaibbenfarhat/tap/easyapply` | Munich + remote-EU job postings in one fast feed — [product page](https://souhaibbenfarhat.github.io/easy-apply) |
